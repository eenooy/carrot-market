...
const Live: NextPage = () => {
    return (
        <div className='py-10 divide-y-2 space-y-4'>
            ...
            <button className='fixed hover:bg-orange-500 cursor-pointer transition-colors bottom-24 right-5 shadow-xl bg-orange-400 rounded-full p-4 border-transparent text-white'>
                <svg
